  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      ...
      <div className="animate-slide-up mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-black text-heading sm:text-3xl">
            {user ? (
        ...
        <div className="flex items-center gap-3">
          {/* Platform Earnings */}
          <div className="flex items-center gap-2 rounded-xl border border-positive/20 bg-positive/5 px-4 py-2.5">
            <FiDollarSign size={16} className="text-positive" />
            <div>
          ...
          {/* Top Earner */}
          {topEarner && (
            <div className="hidden items-center gap-2 rounded-xl border border-accent-2/20 bg-accent-2/5 px-4 py-2.5 sm:flex">
